...
export function renderSourceCard(
  ...
  target.innerHTML = `
    ...
    <div class="source-list">
      <div class="source-row"><span>Official ratio</span><strong data-testid="official-ratio">1 ${snapshot.ticker} = ${btcPerIbit.toFixed(9)} BTC</strong></div>
      <div class="source-row"><span>Shares per BTC</span><strong>1 BTC = ${ibitPerBtc.toFixed(2)} ${snapshot.ticker}</strong></div>
